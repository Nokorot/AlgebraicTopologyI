...
%\newcommand{\@ni}{{n-1}}
% yeah, I know my \ni it's not optimal when working with others because it overrides LaTeX's \ni, that was the reason for adding \nii but I screwed up the definition, lol.
% it's not really needed anyway, it just fits well my shorthands when livetexing (I've redefined \ni to be \cont and a whole bunch of other stuff that I've not added here, lol), but if I'm not in a hurry it's pretty useless.
